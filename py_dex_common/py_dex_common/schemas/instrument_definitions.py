...
class InstrumentDefinitionData(BaseModel):
    ...
    max_order_size: Decimal = Field(..., example="1")
    min_order_incremental_size: Decimal = Field(..., example="1")
    min_order_value_in_quote_ccy: Decimal = Field(..., example="1")
                ...
                "instruments": [
                    {
                        ...
                        "min_order_value_in_quote_ccy": "1",
