...
from pyutils.exchange_connectors.fireblocks_connector import FireblocksConfiguration, FireblocksConnector
...
class WhitelistingManagerFireblocks:
    ...
    def __init__(self, pantheon: Pantheon, dex, config: dict):
        ...
        fireblocks_config = FireblocksConfiguration(config.get("connectors").get("fireblocks"))
        connector = FireblocksConnector(pantheon, fireblocks_config)
        self.__fireblocks_api: FireblocksApi = FireblocksApi(pantheon, connector)
