...
class Main(DexProxy):
    def __init__(self, pantheon: Pantheon):
        ...
        super().__init__(pantheon, web_server, Edex(pantheon, dex_config, web_server, self))

if __name__ == '__main__':
    pt = Pantheon('edex_dex_proxy')
    parser = StandardArgParser('Edex Dex Proxy')
