...
from .uniswap_v3_blx import UniswapV3Bloxroute
...
class Main(DexProxy):
    def __init__(self, pantheon: Pantheon):
        ...
        super().__init__(pantheon, web_server, UniswapV3Bloxroute(pantheon, dex_config, web_server, self))

if __name__ == '__main__':
    pt = Pantheon('uniswap_v3_blx_dex_proxy')
    parser = StandardArgParser('UniswapV3 Blx Dex Proxy')
