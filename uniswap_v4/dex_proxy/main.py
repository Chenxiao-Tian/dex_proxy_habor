...
class Main(DexProxy):
    def __init__(self, pantheon: Pantheon):
        ...
        super().__init__(pantheon, web_server, UniswapV4(pantheon, dex_config, web_server, self))

if __name__ == '__main__':
    pt = Pantheon('uniswap_v4_dex_proxy')
    parser = StandardArgParser('UniswapV4 Dex Proxy')
